        ...
        protected override void LoadDefaultConfig()
        {
            _config = new ConfigData
            {
                ...
                InfoLines = new List<string>
                {
                    ...
                    "",
                    "<color=#FFA500>3. PROTECT GRANDMA</color>",
                    "Each gang has a Grandma at their HQ. She's family - protect her!",
                    "If enemies kill your Grandma, they earn C4 rewards.",
                    "Your gang also gets C4 to seek revenge when Grandma dies.",
                    "Grandma's house is a no-build zone but can be raided.",
                    "",
                    "<color=#95E1D3>4. BUILD YOUR REP</color>",
                    "Take down rivals to earn reputation and climb the ranks.",
                    "The gang with the most territory wins.",
                    "",
                    "<color=#F38181>5. GANG TERRITORIES</color>",
